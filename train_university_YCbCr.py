...
from Datasets.university1 import U1652DatasetEval, U1652DatasetTrain, get_transforms
...
class Configuration:
    ...
    data_folder: str = "/data3/limian1/Documents/LPN-main/data/university-offset-all/off-1"

    # Augment Images
    prob_flip: float = 0.5  # flipping the sat image and drone image simultaneously
    # Savepath for model checkpoints
    model_path: str = "/data3/limian1/Downloads/LRFR-main/result"
...
config.query_folder_train = '/data3/limian1/Documents/LPN-main/data/University-Release/train/satellite'
config.gallery_folder_train = '/data3/limian1/Documents/LPN-main/data/University-Release/train/drone'
